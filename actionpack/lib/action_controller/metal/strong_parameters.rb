...
module ActionController
  ...
  class Parameters
    ...
    # Assign a value to a given +key+. The given key may still get filtered out
    ...
    # Performs values transformation and return the altered
    ...
    # Performs keys transfomration and return the altered
    # <tt>ActionController::Parameters</tt> instance.
    def transform_keys!(&block)
      @parameters.transform_keys!(&block)
      self
    ...
    # Removes items that the block evaluate to true and returns self.
    def reject!(&block)
    ...
    # Return values that was assigned to the given +keys+. Note that all the
