...
module ActionView
  ...
  module Helpers
    ...
    module FormOptionsHelper
      ...
      # if a +User+ model has a +category_ids+ field, and in the form none category is selected no +category_ids+ parameter is sent. So,
      # any mass-assignment idiom like
      #
      #   @user.update(params[:user])
      #
      # wouldn't update the +category_ids+.
      #
      # To prevent this the helper generates an auxiliary hidden field before
