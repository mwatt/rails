...
module ActionView
  ...
  module Helpers
    ...
    module FormTagHelper
      ...
      # ==== Examples
      #   submit_tag
      #   # => <input name="commit" data-disable-with="Please wait..." type="submit" value="Save changes" />
      #
      #   submit_tag "Edit this article"
      #   # => <input name="commit" data-disable-with="Please wait..." type="submit" value="Edit this article" />
      #
      #   submit_tag "Save edits", disabled: true
      #   # => <input disabled="disabled" name="commit" data-disable-with="Please wait..." type="submit" value="Save edits" />
      #
      #   submit_tag "Complete sale", data: { disable_with: "Submitting..." }
      #   # => <input name="commit" data-disable-with="Submitting..." type="submit" value="Complete sale" />
      #
      #   submit_tag nil, class: "form_submit"
      #   # => <input class="form_submit" data-disable-with="Please wait..." name="commit" type="submit" />
      #
      #   submit_tag "Edit", class: "edit_button"
      #   # => <input class="edit_button" data-disable-with="Please wait..." name="commit" type="submit" value="Edit" />
      #
      #   submit_tag "Save", data: { confirm: "Are you sure?" }
      #   # => <input name='commit' type='submit' value='Save' data-disable-with="Please wait..." data-confirm="Are you sure?" />
      #
      def submit_tag(value = "Save changes", options = {})
        options = options.stringify_keys
        tag_options = { "type" => "submit", "name" => "commit", "value" => value }.update(options)

        unless tag_options.include?("data-disable-with") || (tag_options["data"] && tag_options["data"][:disable_with])
