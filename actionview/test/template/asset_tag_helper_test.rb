...
class AssetTagHelperTest < ActionView::TestCase
  ...
  ImageLinkToTag = {
    ...
    %(image_tag("gold.png", :height => "150", :width => "100", :size => "20")) => %(<img alt="Gold" height="20" src="/images/gold.png" width="20" />),
    %(image_tag("gold.png", :size => "45x70")) => %(<img alt="Gold" height="70" src="/images/gold.png" width="45" />),
    %(image_tag("gold.png", "size" => "45x70")) => %(<img alt="Gold" height="70" src="/images/gold.png" width="45" />),
    %(image_tag("gold.png", :height => "150", :width => "100", :size => "45x70")) => %(<img alt="Gold" height="70" src="/images/gold.png" width="45" />),
    %(image_tag("error.png", "size" => "45 x 70")) => %(<img alt="Error" src="/images/error.png" />),
    %(image_tag("error.png", "size" => "x")) => %(<img alt="Error" src="/images/error.png" />),
    %(image_tag("gold.png", :height => "150", :width => "100", :size => "square")) => %(<img alt="Gold" height="150" src="/images/gold.png" width="100" />),
