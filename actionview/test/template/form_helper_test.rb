...
class FormHelperTest < ActionView::TestCase
  ...
  def test_form_for_with_model_using_relative_model_naming
    ...
    expected = whole_form("/posts/44", "edit_post_44", "edit_post", method: "patch") do
      ...
      "<input name='commit' data-disable-with='Please wait...' type='submit' value='Edit post' />"
    end
  ...
  def test_form_for_with_symbol_object_name
    ...
    expected =  whole_form("/posts/123", "create-post", "edit_other_name", method: "patch") do
      ...
      "<input name='commit' value='Create post' data-disable-with='Please wait...' type='submit' />"
    end
  ...
  def test_submit_with_object_as_existing_record_and_locale_strings
    with_locale :submit do
      ...
      expected = whole_form('/posts/123', 'edit_post_123', 'edit_post', method: 'patch') do
      "<input name='commit' data-disable-with='Please wait...' type='submit' value='Confirm Post changes' />"
      end
  ...
  def test_submit_without_object_and_locale_strings
    with_locale :submit do
      ...
      "<input name='commit' class='extra' data-disable-with='Please wait...' type='submit' value='Save changes' />"
      end
  ...
  def test_submit_with_object_and_nested_lookup
    with_locale :submit do
      ...
      "<input name='commit' data-disable-with='Please wait...' type='submit' value='Update your Post' />"
      end
