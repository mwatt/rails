...
module ActiveJob
  ...
  # types that mixin +GlobalID::Identification+ (e.g. ActiveRecord models),
  # arrays with serializable values, and hashes with string and symbol keys and
  # serialazible values. This will also be raised when GlobalID fails to
  # create a unique identifier for the supplied object as would happen if you
  # tried to serialize an unpersisted ActiveRecord model.
