module ActiveJob
  ...
  # * {Active Job Async}[http://api.rubyonrails.org/classes/ActiveJob/QueueAdapters/AsyncAdapter.html]
  ...
  # asynchronously on a background thread pool. All job data
  ...
  # but excellent for development and testing. See the
