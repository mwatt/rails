...
module ActiveRecord
  module ConnectionAdapters #:nodoc:
    ...
    class ColumnDefinition < Struct.new(:name, :type, :limit, :precision, :scale, :default, :null, :expression, :first, :after, :auto_increment, :primary_key, :collation, :sql_type) #:nodoc:
