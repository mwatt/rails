...
module ActiveRecord
  class CustomPropertiesTest < ActiveRecord::TestCase
    ...
    test "overloading properties does not attribute method order" do
      ...
      assert_equal %w(id overloaded_float unoverloaded_float overloaded_string_with_limit string_with_default non_existent_decimal string_with_default_proc), attribute_names
    end
