ActiveRecord::Schema.define do
  create_table :binary_fields, force: true do |t|
    ...
    t.tinyblob :tiny_blob, limit: 255
    t.binary :normal_blob, limit: 65535
    t.mediumblob :medium_blob, limit: 16777215
    t.longblob :long_blob, limit: 2147483647
    t.tinytext :tiny_text, limit: 255
    t.text   :normal_text, limit: 65535
    t.mediumtext :medium_text, limit: 16777215
    t.longtext :long_text, limit: 2147483647
  end
