ActiveRecord::Schema.define do
  ...
  create_table :defaults, force: true do |t|
    t.date :modified_date, expression: 'CURRENT_DATE'
    t.date :modified_date_function, expression: 'now()'
    t.date :fixed_date, default: '2004-01-01'
    t.datetime :modified_time, expression: 'CURRENT_TIMESTAMP'
    t.datetime :modified_time_function, expression: 'now()'
    t.datetime :fixed_time, default: '2004-01-01 00:00:00.000000-00'
    t.column :char1, 'char(1)', default: 'Y'
    t.string :char2, limit: 50, default: 'a varchar field'
    t.text :char3, default: 'a text field'
    t.bigint :bigint_default, expression: '0::bigint'
