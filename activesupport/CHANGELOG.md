...
*   Add `Callbacks.halt_and_display_warning_on_return_false`

    Setting `Callbacks.halt_and_display_warning_on_return_false`
    ...
    The value can also be set with the configuration option
