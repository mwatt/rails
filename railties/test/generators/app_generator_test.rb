...
class AppGeneratorTest < Rails::Generators::TestCase
  ...
  def test_spring_binstubs
    ...
    generator.stubs(:bundle_command).with { |val| val.match(/^install/i) }
  ...
  def test_after_bundle_callback
    ...
    generator.expects(:bundle_command).with { |val| val.match(/^install/i) }.once.in_sequence(bundler_first)
